    ...
    override fun onCreate(SavedInstanceState: Bundle?) {
        ...
        when (EditParams.getString("Mode")) {
            ...
            "Edit" -> {
                ...
                TimeMonEdit.setText(T.monthValue.toString())
                TimeDayEdit.setText(T.dayOfMonth.toString())
                TimeHrEdit.setText(T.hour.toString())
                TimeMinEdit.setText(T.minute.toString())
                TimeSecEdit.setText(T.second.toString())
