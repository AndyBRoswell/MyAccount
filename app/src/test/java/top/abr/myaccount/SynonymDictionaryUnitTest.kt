...
//            }
            ...
            for (Interval in Intervals) {                                           // Insertion test
                for (j in 0 until Interval.second - 1) SDict.Insert(SList[i][j], SList[i][j + 1])
            }
            for (j in 0 until Intervals.size - 1) {                                 // Merge test
